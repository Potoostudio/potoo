    ...
    // handleBoxToggleWeb = () => this.setState({ showWeb: !this.state.showWeb })
      ...
      render() {
          ...
          return (
            <>
              <Head>
                <title>A branding agency in Denver</title>
                <link rel="icon" href="favicon.png" />
                <link rel="manifest" href="/manifest.json"/>
                <meta name="description" content="A Branding Agency in Denver"/>
                <meta name="viewport" content="width=device-width, initial-scale=1" />
                <meta name="keywords" content="A branding agency in Denver, creative agency in Denver, branding in Denver, Denver branding agency," />
              </Head>
