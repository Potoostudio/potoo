  ...
  return (
    <>
      ...
      <motion.div className="row home-page-row-project-images mb-5 mb-md-1 mt-md-2 justify-content-end px-0 px-md-0 pt-2x pb-2x"
        ...
        <div className="col-md-7 col-12 py-md-4 pt-0 px-md-0 pb-md-0 mb-md-0">
            <h1 className="pt-2 px-md-4 py-4 text-md-left hover-none mb-0 color-dark py-0">
                Art is part of our identity
            </h1>
        </div>
        <div className="col-md-7 col-12 px-0">
          <h5 className="py-4 px-3 px-md-4 color-dark line-height-normal font-weight-normal pt-md-5">
      ...
      <div className="container-fluid pt-5 mb-10x">
