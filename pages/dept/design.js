...
export default function Studio(){
          ...
          return (
            <>
              <Head>
                <title>A Branding Agency Baghdad</title>
                <link rel="icon" href="favicon.png" />
                <link rel="manifest" href="/manifest.json"/>
                <meta name="description" content="A Branding Agency Based in Baghdad"/>
                <meta name="keywords" content="A branding agency in baghdad, A creative agency in baghdad, best marketing agency in baghdad, top marketing agency in baghdad, branding in baghdad, Top Advertising Agency in baghdad"/>
              ...
              <div className="container-fluid pt-8x pb-5 mb-md-5 border-top">
